...
!TOR3D
   ...
   DO iel = 1, N2D
      ...
      if (switch%testcase == 60) then
         q_cylel = geom%q
         ! to finish this
         omegael = norm2(Bel, dim=2)*simpar%refval_charge/simpar%refval_mass*simpar%refval_time
      else
...
#endif
#ifdef KEQUATION
      real*8 :: kappa, epsil, kappa_epsil, d_ke
#endif
...
#endif
#ifdef KEQUATION
      call compute_ke_dke(uf, kappa_epsil, d_ke)
#ifdef DKLINEARIZED
